...
4️⃣ idx = 3 → -1 → ❌ (left of 4)
5️⃣ idx = 4 → -1 → ❌ (right of 4)
...
1️⃣2️⃣ idx = 11 → -1 → ❌ (left of 6)
1️⃣3️⃣ idx = 12 → -1 → ❌ (right of 6)
